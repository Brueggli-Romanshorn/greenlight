  ...
  def create_site_settings
    SiteSetting.create! [
      ...
      { setting: Setting.find_by(name: 'BrandingImage'),
        ...
        provider: @provider },
      { setting: Setting.find_by(name: 'Terms'), value: 'false', provider: @provider },
      { setting: Setting.find_by(name: 'TermsText'), value: '[{"type":"paragraph","children":[{"text":""}]}]', provider: @provider },
      { setting: Setting.find_by(name: 'PrivacyPolicy'), value: 'false', provider: @provider },
      { setting: Setting.find_by(name: 'PrivacyText'), value: '[{"type":"paragraph","children":[{"text":""}]}]', provider: @provider },
      { setting: Setting.find_by(name: 'Imprint'), value: 'false', provider: @provider },
      { setting: Setting.find_by(name: 'ImprintText'), value: '[{"type":"paragraph","children":[{"text":""}]}]', provider: @provider },
